...
namespace PowerAutomateForCrmSolution
{
	...
	[Export(typeof(IXrmToolBoxPlugin)),
		ExportMetadata("Name", "PowerAutomateForCrmSolution"),
		ExportMetadata("Description", "Provide ability to create a new crm PowerAutomate using common data service connectors and add it to crm solution selected. Works with OAuth or Certifcate type connections only."),
