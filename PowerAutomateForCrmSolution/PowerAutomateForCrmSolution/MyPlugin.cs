...
namespace PowerAutomateForCrmSolution
{
	...
	[Export(typeof(IXrmToolBoxPlugin)),
		...
		ExportMetadata("Description", "Provide ability to create a new crm cloud PowerAutomate workflow using common data service connectors to selected crm solution only. Works with OAuth or Certifcate type connections only."),
